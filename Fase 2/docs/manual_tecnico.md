...
1. **Colecciones Principales**:
    ...
    - **ColeccionAeropuertos**: Registra los aeropuertos, como el id, el nombre, ciudad, pais, y los codigos
...
2. **Relaciones y Referencias**:
    - Las relaciones entre colecciones se establecen mediante referencias usando el campo ObjectId de los documentos. Por ejemplo, ColeccionVuelos referencia a ColeccionAeronaves y ColeccionAeropuertos para asociar una aeronave y a un vuelo específico las locaciones.
...
> *Actualizacion: El motivo del cambio de los esquemas fue que nos dimos cuenta que una coleccion estados era innecesaria ya que conocemos los estados posibles. Y el agregar una coleccion aeropuertos lo vimos necesario ya que un vuelo su origen y llegada son a aeropuertos entonces pues lo vimos necesario.*
