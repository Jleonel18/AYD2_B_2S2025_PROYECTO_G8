...
const VerifyAccount = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/users/verificar-password`, {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                toast.error(data.error || 'Error al restablecer la contraseña. Inténtalo de nuevo.');
            }
        } catch (error) {
    ...
    return (
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-1/3">
            <h2 className="text-2xl font-bold text-[#333446] text-center mb-6">Reestablecer contraseña</h2>
